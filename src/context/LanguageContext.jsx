...
const translations = {
  uz: {
    nav: { otherDoors: 'Boshqa eshiklar', products: 'Mahsulotlar', contact: 'Biz bilan bog‘laning', call: 'Qo‘ng‘iroq qilish', menu: 'Asosiy navigatsiya', open: 'Menyuni ochish', close: 'Menyuni yopish', brand: 'Siz tanigan brend' },
    otherDoors: { title: 'BOSHQA ESHIKLAR', description: 'Klassik va o‘ziga xos dizayndagi eshiklar kolleksiyasi.' },
  ...
  ru: {
    nav: { otherDoors: 'Другие двери', products: 'Продукты', contact: 'Связаться с нами', call: 'Позвонить', menu: 'Основная навигация', open: 'Открыть меню', close: 'Закрыть меню', brand: 'Бренд, которому доверяют' },
    otherDoors: { title: 'ДРУГИЕ ДВЕРИ', description: 'Коллекция дверей с классическим и выразительным дизайном.' },
  ...
  en: {
    nav: { otherDoors: 'Other doors', products: 'Products', contact: 'Contact us', call: 'Call us', menu: 'Main navigation', open: 'Open menu', close: 'Close menu', brand: 'A brand you know' },
    otherDoors: { title: 'OTHER DOORS', description: 'A collection of doors with classic and distinctive designs.' },
  ...
  kk: {
    nav: { otherDoors: 'Басқа есіктер', products: 'Өнімдер', contact: 'Бізбен байланысыңыз', call: 'Қоңырау шалу', menu: 'Негізгі навигация', open: 'Мәзірді ашу', close: 'Мәзірді жабу', brand: 'Сіз білетін бренд' },
    otherDoors: { title: 'БАСҚА ЕСІКТЕР', description: 'Классикалық және ерекше дизайны бар есіктер топтамасы.' },
  ...
  tg: {
    nav: { otherDoors: 'Дарҳои дигар', products: 'Маҳсулотҳо', contact: 'Бо мо тамос гиред', call: 'Занг задан', menu: 'Навигатсияи асосӣ', open: 'Кушодани меню', close: 'Пӯшидани меню', brand: 'Бренди шинос' },
    otherDoors: { title: 'ДАРҲОИ ДИГАР', description: 'Маҷмӯаи дарҳо бо тарҳи классикӣ ва хоси худ.' },
  ...
  tk: {
    nav: { otherDoors: 'Beýleki gapylar', products: 'Önümler', contact: 'Biz bilen habarlaşyň', call: 'Jaň etmek', menu: 'Esasy nawigasiýa', open: 'Menýuny açmak', close: 'Menýuny ýapmak', brand: 'Tanaýan brendiňiz' },
    otherDoors: { title: 'BEÝLEKI GAPYLAR', description: 'Klassiki we tapawutly dizaýnly gapylaryň ýygyndysy.' },
