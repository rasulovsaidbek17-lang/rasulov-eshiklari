    ...
    <section ref={ref} className="bg-white">
      <div className="container-px py-16 md:py-24">
        <div data-reveal className="max-w-2xl mb-12">
          ...
          <h2 className="font-display font-extrabold text-3xl md:text-4xl text-charcoal">MAHSULOTLARIMIZ</h2>
          <p className="mt-3 text-charcoal-400">Siz uchun eng yaxshi eshiklar va mebellar</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {categories.map((c, i) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-charcoal/85 via-charcoal/10 to-transparent transition-opacity duration-500 group-hover:from-charcoal/95" />
